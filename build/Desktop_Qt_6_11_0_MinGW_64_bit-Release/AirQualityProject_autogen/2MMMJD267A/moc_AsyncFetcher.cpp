...
void AsyncFetcher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->offlineModeActive(); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (AsyncFetcher::*)(const Measurement & )>(_a, &AsyncFetcher::measurementFetched, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (AsyncFetcher::*)()>(_a, &AsyncFetcher::offlineModeActive, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (AsyncFetcher::*)(const QString & )>(_a, &AsyncFetcher::fetchError, 3))
            return;
        if (QtMocHelpers::indexOfMethod<void (AsyncFetcher::*)(int )>(_a, &AsyncFetcher::progressChanged, 4))
            return;
    }
}
...
// SIGNAL 2
void AsyncFetcher::offlineModeActive()
{
